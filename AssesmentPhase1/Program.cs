...
namespace AssesmentPhase1
{
    
        class Program
        {
//public static string filename = "C:\\Users\\NagaRanjitha_Bhat\\source\\repos\\AssesmentPhase1\\Rainbow_School.txt";
            static void Main(string[] args)
            {
            schoolTeachersData();
            }

            public static void schoolTeachersData()
            {
                Console.WriteLine("\t \t \t Welcome to Rainbow School.");
                Console.WriteLine("*************************************************************************************");
               
                string filename = "C:\\Users\\NagaRanjitha_Bhat\\source\\repos\\AssesmentPhase1\\Rainbow_School.txt";
                string[] data;
                ...
                do
                {
                    ...
                    start:
                        foreach (var ID in IDs)
                        {
                            ...
                            {
                                if (string.Equals(SId, split[0].Trim()))
                                {
                    ...
                    if (num == 2)
                    {
                        ...
                        {
                            split = ID.Split('\t');
                            if (string.Equals(IDretrieved, split[0].Trim()))
                            {
